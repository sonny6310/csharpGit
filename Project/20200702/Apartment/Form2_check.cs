...
namespace Apartment
{
    public partial class Form2_check : Form
    {
        ...
        private string loginConn = "Data Source=munggu.iptime.org,25000;Initial Catalog=jh_20200611;Persist Security Info=True;User Id=sa;Password=8765432!";
        ...
        private void btn_check_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("동 호수를 모두 입력하시오.", "확인", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
